...
/**
 * Test the functions in {@link CountryFunctions}
 */
...
public class CountryFunctionsTest {
	...
	public void testWriteToProperties() {
		...
		assertTrue( "Africa", props.containsKey( "Africa" ) );
		assertTrue( "Asia", props.containsKey( "Asia" ) );
		assertTrue( "Europe", props.containsKey( "Europe" ) );
		assertTrue( "North America", props.containsKey( "North America" ) );
		assertTrue( "South America", props.containsKey( "South America" ) );
		assertThat( "Oceania", props.getProperty( "Oceania" ), is(
